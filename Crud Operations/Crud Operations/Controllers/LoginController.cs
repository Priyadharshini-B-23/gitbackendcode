...
namespace Crud_Operations.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        [HttpPost]
        public ActionResult FindProviderEmail([FromBody] Finduser email)
        {
            var Email = _context.ProviderSignup.Where(s => s.JobProviderEmailId == email.Email).FirstOrDefault();
            if (Email == null)
            {
                return Ok("Not the data");
            }
